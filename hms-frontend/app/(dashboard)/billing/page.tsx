              ...
              <div className="p-5 border-b border-theme-border">
                  ...
                  <tbody className="divide-y divide-theme-border/50">
                    {folioData.items.map((item: any, i: number) => (
                      <tr key={i}>
                        ...
                        <td className="py-2 text-xs text-theme-muted-light text-right">{currencySymbol} {item.rate.toFixed(2)}</td>
                        <td className="py-2 text-xs text-theme-text font-medium text-right">{currencySymbol} {item.amount.toFixed(2)}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
                ...
                <div className="flex flex-col gap-2 mt-4 pt-4 border-t border-theme-border/50 bg-theme-secondary/30 p-3 rounded-xl">
                  ...
                  <div className="flex justify-between text-sm mt-1">
                    <span className="text-theme-text font-bold">Balance Due</span>
                    <span className="text-red-400 font-bold">{currencySymbol} {folioData.balanceDue.toFixed(2)}</span>
                  </div>
                </div>
              </div>
