...
export default function BookingCalendar({ rooms, bookings }: BookingCalendarProps) {
  ...
  return (
    <div className="bg-theme-card shadow-soft border border-theme-border rounded-2xl flex flex-col overflow-hidden h-full">
      <div className="flex flex-col xl:flex-row xl:items-center justify-between p-3 border-b border-theme-border gap-2">
        <h2 className="text-sm font-bold text-theme-text whitespace-nowrap shrink-0">Calendar View</h2>
        ...
        <div className="flex flex-wrap items-center gap-2 w-full xl:w-auto justify-between xl:justify-end">
          ...
          <select 
            ...
            className="bg-theme-secondary border border-theme-border rounded-md px-2 py-1 text-[10px] text-theme-muted-light focus:outline-none focus:ring-1 focus:ring-primary/50 focus:border-primary shrink-0 max-w-[100px]"
          >
