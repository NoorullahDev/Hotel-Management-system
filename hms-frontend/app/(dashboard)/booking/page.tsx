...
export default function BookingPage() {
  ...
  // Filtering is now server-side; bookings is already the filtered page result.
  ...
  return (
    <div className="flex flex-col gap-6 h-full p-2 overflow-x-hidden">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-theme-text mb-1">Booking Management</h1>
          <p className="text-theme-muted text-sm">Manage all hotel bookings, reservations and guest stays</p>
        </div>
      ...
      <div className="grid grid-cols-[1.1fr_1.4fr] gap-6 flex-1 min-h-0">
        ...
        <div className="flex flex-col bg-theme-card shadow-soft border border-theme-border rounded-2xl h-full pb-20">
            ...
            <table className="w-full text-left border-collapse min-w-full">
              ...
              <tbody className="divide-y divide-theme-border">
                {loading ? (
                  ...
                  <tr><td colSpan={8} className="p-8 text-center text-theme-muted text-xs">No bookings found.</td></tr>
                ) : (
